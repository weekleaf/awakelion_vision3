...
//    }
    ...
    moto_move_pitch=moto_pitch/*-moto_pitch*//*-abs(tvec(1,0))/tvec(1,0)*M_PI/2.0*/;//电控收角度制，发给他们前需要转成角度制
